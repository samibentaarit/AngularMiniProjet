...
import {BibliothequeComponent,BibliothequeDialog, BibliothequeEditDialog} from './pages/bibliotheque/bibliotheque.component';
...
import { DiscountLabelDirective } from './directives/discount-label.directive';
