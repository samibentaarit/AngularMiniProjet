...
export class EquipementComponent implements OnInit {
  ...
  search() {
    ...
    this.filteredEquipments = this.equipements.filter(equipment =>
      equipment.nom.toLowerCase().includes(this.searchTerm.toLowerCase())
    );
  }
  ...
  loadEquipements(): void {
    this.equipementService.getAllEquipements().subscribe(
      (data: Equipement[]) => {
        ...
        this.filteredEquipments = this.equipements; // Initially, show all equipment
      },
      (error) => {
